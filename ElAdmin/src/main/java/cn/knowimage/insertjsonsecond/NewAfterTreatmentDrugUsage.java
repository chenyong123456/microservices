 ...
 * @author Mr.G
 * @date 2019/8/12
 * 将前端输入的after_treatment_drug_usageJson字段格式修改成数据库规定的json格式
 */
public class NewAfterTreatmentDrugUsage {
    public static JSONObject after_treatment_drug_usageJson(String after_treatmentAntibio_usage, String after_treatmentAnaesthetic_usage,
                                                            String after_treatmentOtherdrugs_usage) {
        ...
        if (after_treatmentAntibio_usage_s==null||after_treatmentAntibio_usage_s.size()==0){
        ...
        if (after_treatmentAnaesthetic_usage_s==null||after_treatmentAnaesthetic_usage_s.size()==0){
        ...
        if (after_treatmentOtherdrugs_usage_s==null||after_treatmentOtherdrugs_usage_s.size()==0){
        ...
        return after_treatment_drug_usageJson;
    }
}
