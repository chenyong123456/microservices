 ...
 * @author Mr.G
 * @date 2019/8/12
 * 将前端输入的treatment字段格式修改成数据库规定的json格式
 */
public class NewTreatment {
    public static JSONObject scenario_id;

    public static JSONObject treatment(String treatment_days_duration, String duration_treatment_min,
                                       String duration_treatment_max, String duration_treatment_text, String sceneList) {
        //定义总对象
        ...
        if (scenario==null||scenario.size()==0){
            ...
            scenario_id_0.put("notification",notification);
            scenario_s.put("scenario_num",1);
