	...
	document.body.onscroll = function(){ 
		...
		$(".search_button").click(function(){
			...
			if(search_name != ""){
				...
				//window.location.href="http://192.168.50.118:8088/pathway_form/aa/new_bdbk?list_name="+encodeURI(search_name);
			}else{
		...
		$.ajax({
			...
			//url: "http://192.168.50.118:8088/pathway_form/pathway_InfoBy_Only_pathway_name", //地址，就是json文件的请求路径
