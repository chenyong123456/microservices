...
public interface AuditInfoMapper {
	...
	public List<AuditInfo> selectByPathway_id(@Param("pathway_id") Integer pathway_id);
	...
	public List<AuditInfo> findAll(@Param("pathway_name") String pathway_name, @Param("audit_state1") Integer audit_state1, @Param("audit_state2") Integer audit_state2,
	...
	public List<AuditInfo> selectByName(@Param("submitter") String submitter);
	...
	public List<AuditInfo> selectByNameToTime(@Param("submitter") String submitter, @Param("time1") String time1, @Param("time2") String time2);
	...
	public List<AuditInfoAndPathwayInfo> selectById(@Param("page") Integer page, @Param("rows") Integer rows, @Param("pathway_name") String pathway_name,
	 ...
	 * 根据Pathway_name查询
	 */
	public List<AuditInfo> selectByPathway_name(@Param("selectName") String selectName);

	/**
	 * 根据id查询Audit_Info表里的submitter字段
	 */
	public List<AuditInfo> selectId(@Param("selectName") Integer selectName);
